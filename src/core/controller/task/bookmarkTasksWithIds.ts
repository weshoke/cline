...
/**
 * Bookmark tasks with the specified IDs
 * @param controller The controller instance
 * @param request The request containing an array of task IDs to delete
 * @returns Empty response
 * @throws Error if operation fails
 */
export const bookmarkTasksWithIds: TaskMethodHandler = async (
	...
	await Promise.all(request.value.map((value) => controller.bookmarkTaskWithId(value)))
